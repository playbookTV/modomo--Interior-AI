...
async def startup():
    ...
    try:
        # Database connection
        DATABASE_URL = os.getenv("DATABASE_URL", "postgresql://reroom:reroom_dev_pass@localhost:5432/reroom_dev")
...
if __name__ == "__main__":
    try:
        ...
        uvicorn.run("main-basic:app", host="0.0.0.0", port=8001, log_level="info")
    except ImportError:
